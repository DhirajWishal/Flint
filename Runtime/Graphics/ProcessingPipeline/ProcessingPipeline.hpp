...
namespace Flint
{
	...
	public:
		 ...
		 */
		uint32_t GetBufferCount() const { return pScreenBoundRenderTarget->GetBufferCount(); }
		 ...
		 */
		uint32_t GetCurrentFrameIndex() const { return pScreenBoundRenderTarget->GetFrameIndex(); }
		 ...
		 */
		uint32_t GetCurrentImageIndex() const { return pScreenBoundRenderTarget->GetImageIndex(); }
