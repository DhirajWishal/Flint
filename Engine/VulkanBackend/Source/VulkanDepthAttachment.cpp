...
namespace Flint
{
	...
	{
		VulkanDepthAttachment::VulkanDepthAttachment(VulkanDevice& device, uint32_t width, uint32_t height, Core::PixelFormat format, Core::Multisample multisample)
			: VulkanRenderTargetAttachment(device, width, height, Core::AttachmentType::Depth, format, multisample)
		{
			// Create the image.
