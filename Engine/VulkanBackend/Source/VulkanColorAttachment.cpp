...
namespace Flint
{
	...
	{
		VulkanColorAttachment::VulkanColorAttachment(VulkanDevice& device, uint32_t width, uint32_t height,PixelFormat format, Multisample multisample)
			: VulkanRenderTargetAttachment(device, width, height, AttachmentType::Color, format, multisample)
		{
			// Create the image.
