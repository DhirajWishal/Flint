...
namespace Flint
{
	...
	public:
		 ...
		 */
		void setDependency(const RenderTarget<TDevice>* pRenderTarget, uint32_t attachment) { m_Dependency = std::make_pair(pRenderTarget, attachment); }
	...
	protected:
		std::pair<const RenderTarget<TDevice>*, uint32_t> m_Dependency;
