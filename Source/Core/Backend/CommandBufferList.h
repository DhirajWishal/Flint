...
namespace Flint
{
	namespace Backend
	{
		...
		{
		public:
			CommandBufferList(Device* pDevice, UI64 bufferCount) : pDevice(pDevice), mBufferCount(bufferCount) {}
			 ...
			 */
			virtual void BindVertexBuffer(const Buffer* pBuffer) = 0;
			 ...
			 */
			virtual void BindIndexBuffer(const Buffer* pBuffer) = 0;
			 ...
			 */
			virtual void BindPipeline(const GraphicsPipeline* pGraphicsPipeline) = 0;
			 ...
			 */
			virtual void BindRenderResource(const PipelineResource* pResource) = 0;
