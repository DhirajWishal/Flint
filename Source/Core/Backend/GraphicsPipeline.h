...
namespace Flint
{
	namespace Backend
	{
		...
		{
		public:
			GraphicsPipeline(RenderTarget* pRenderTarget, const std::vector<ShaderDigest>& shaderDigests, const GraphicsPipelineSpecification& spec) : Pipeline(pRenderTarget, shaderDigests), mSpec(spec) {}
