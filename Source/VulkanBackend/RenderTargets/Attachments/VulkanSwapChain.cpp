...
#include "RenderTargets/Attachments/VulkanSwapChain.h"
...
namespace Flint
{
	...
	{
		void VulkanSwapChain::Initialize(VulkanDevice* pDevice, VulkanDisplay* pDisplay, const Vector2& extent, UI32 bufferCount)
		{
