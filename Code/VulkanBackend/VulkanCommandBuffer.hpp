...
namespace Flint
{
	namespace VulkanBackend
	{
		...
		public:
			...
			virtual void BindResourcePackage(const std::shared_ptr<GraphicsPipeline>& pPipeline, const std::shared_ptr<ResourcePackage>& pResourcePackage) override;
			...
			virtual void BindResourcePackage(const std::shared_ptr<ComputePipeline>& pPipeline, const std::shared_ptr<ResourcePackage>& pResourcePackage) override;
		...
		public:
			...
			const VkSubmitInfo* GetSubmitInfoAddress();
