...
namespace Flint
{
	namespace VulkanBackend
	{
		...
		void VulkanDisplay::ActivateKey(UI32 scanCode, UI32 action, SpecialCharacter character)
		{
			mKeyEvents[static_cast<UI8>(mKeyMap[scanCode])].Activate(mActionMap[action], character);
		}

		void VulkanDisplay::ActivateMouseButton(UI32 scanCode, UI32 action, SpecialCharacter character)
		{
			mMouseButtonEvents[static_cast<UI8>(mButtonMap[scanCode])].Activate(mActionMap[action], character);
		}
		...
		void VulkanDisplay::SetupMaps()
		{
			...
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_KP_DECIMAL)] = KeyCode::KP_DECIMAL;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_KP_DIVIDE)] = KeyCode::KP_DIVIDE;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_KP_MULTIPLY)] = KeyCode::KP_MULTIPLY;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_KP_SUBTRACT)] = KeyCode::KP_SUBTRACT;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_KP_ADD)] = KeyCode::KP_ADD;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_KP_ENTER)] = KeyCode::KP_ENTER;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_KP_EQUAL)] = KeyCode::KP_EQUAL;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_LEFT_SHIFT)] = KeyCode::LEFT_SHIFT;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_LEFT_CONTROL)] = KeyCode::LEFT_CONTROL;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_LEFT_ALT)] = KeyCode::LEFT_ALT;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_LEFT_SUPER)] = KeyCode::LEFT_SUPER;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_RIGHT_SHIFT)] = KeyCode::RIGHT_SHIFT;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_RIGHT_CONTROL)] = KeyCode::RIGHT_CONTROL;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_RIGHT_ALT)] = KeyCode::RIGHT_ALT;
			mKeyMap[glfwGetKeyScancode(GLFW_KEY_RIGHT_SUPER)] = KeyCode::RIGHT_SUPER;
