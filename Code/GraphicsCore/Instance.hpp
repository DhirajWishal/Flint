...
namespace Flint
{
	...
	public:
		 ...
		 */
		virtual boost::shared_ptr<Device> CreateDevice(const DeviceFlags flags) = 0;
		 ...
		 */
		virtual boost::shared_ptr<Display> CreateDisplay(const FBox2D& extent, const std::string& title) = 0;
